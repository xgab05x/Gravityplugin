...
public class GravityCommands implements CommandExecutor {
        ...
        if (args.length == 2) {
            ...
            if (target != null) {
                if (!Gravity.getInstance().getExcludedPlayers().contains(target.getName())) {
                    ...
                    sender.sendMessage("§7" + target.getName() + " è stato escluso dalla gravità.");
                } else {
                    sender.sendMessage("§7" + target.getName() + " è già escluso dalla gravità.");
                }
            } else {
                sender.sendMessage("§cGiocatore non trovato.");
            }
        } else {
            sender.sendMessage("§cUso corretto: /gravity exclude <giocatore>");
        }
        return true;
    }
        ...
        if (args.length == 2) {
            ...
            if (target != null) {
                if (Gravity.getInstance().getExcludedPlayers().contains(target.getName())) {
                    ...
                    sender.sendMessage("§7" + target.getName() + " è stato incluso di nuovo nella gravità.");
                } else {
                    sender.sendMessage("§7" + target.getName() + " non è escluso dalla gravità.");
                }
            } else {
                sender.sendMessage("§cGiocatore non trovato.");
            }
        } else {
            sender.sendMessage("§cUso corretto: /gravity include <giocatore>");
        }
        return true;
    }
    ...
    private boolean handleExcludedList(CommandSender sender) {
        ...
        if (Gravity.getInstance().getExcludedPlayers().isEmpty()) {
            sender.sendMessage("§7Non ci sono giocatori esclusi dalla gravità.");
        } else {
            sender.sendMessage("§7Giocatori esclusi dalla gravità:");
    ...
    private boolean handleReload(CommandSender sender) {
        ...
        sender.sendMessage("§7Plugin ricaricato con successo.");
        return true;
    }
        ...
        if (args.length == 1) {
            if (sender instanceof Player) {
                ...
                if (player.getInventory().getHelmet() != null) {
                    player.sendMessage("§cHai già un altro casco. Questo verrà sostituito.");
                ...
                player.sendMessage("§7Hai indossato il casco spaziale.");
            }
            ...
            if (target != null) {
                ...
                if (target.getInventory().getHelmet() != null) {
                    sender.sendMessage("§7" + target.getName() + " ha già un altro casco. Questo verrà sostituito.");
                ...
                sender.sendMessage("§7Hai dato il casco spaziale a " + target.getName() + ".");
                target.sendMessage("§7Hai indossato un casco spaziale.");
            } else {
                sender.sendMessage("§cGiocatore non trovato.");
            }
        } else {
            sender.sendMessage("§cUso corretto: /gravity wearspacehelmet <giocatore>");
        }
        return true;
    }
}
